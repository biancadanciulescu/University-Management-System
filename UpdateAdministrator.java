...
class UpdateAdministrator implements ActionListener{
  ...
  public  UpdateAdministrator(String nume,String prenume,String CNP){
        f=new JFrame("Update Administrator details");
        f.setSize(900,650);
        ...
        id8 = new JLabel("Update Administrator Details:");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                ...
                String str = "update administrator set nume='"+t1.getText()+"',prenume='"+t2.getText()+"',adresa='"+t3.getText()+"', nr_telefon='"+t4.getText()+"',email='"+t5.getText()+"',IBAN='"+t6.getText()+"' where CNP='"+t12.getText()+"'";
                con.s.executeUpdate(str);
                JOptionPane.showMessageDialog(null,"successfully updated");
                f.setVisible(false);
                new ADDetails(t1.getText(),t2.getText(),t12.getText(),t1.getText(),t2.getText());
            }catch(Exception e){
    ...
    public static void main(String[] arg){
        new UpdateAdministrator(null,null,null).f.setVisible(true);
    }
}