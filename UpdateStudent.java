...
class UpdateStudent implements ActionListener{
  ...
  public  UpdateStudent(String nume,String prenume,String CNP,String NUME,String PRENUME){
	  backgr= new ImageIcon(this.getClass().getResource("/bus.jpeg"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                ...
                String str = "update student set nume='"+t1.getText()+"',prenume='"+t2.getText()+"',adresa='"+t3.getText()+"', nr_telefon='"+t4.getText()+"',email='"+t5.getText()+"',IBAN='"+t6.getText()+"' where CNP='"+t12.getText()+"'";
                con.s.executeUpdate(str);
                JOptionPane.showMessageDialog(null,"successfully updated");
                f.setVisible(false);
                new StudDetails(t1.getText(),t2.getText(),t12.getText(),t1.getText(),t2.getText());
            }catch(Exception e){
    ...
    public static void main(String[] arg){
        new UpdateStudent(null,null,null,null,null).f.setVisible(true);
    }
}